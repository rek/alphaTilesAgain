...
| Chile | 1-digit difficulty | `1`→6 guess rows, `2`→4, `3`→2 (Phonemic Wordle) |
| Japan | 1-digit difficulty | tile-cap per round; landscape-only; partial credit walks tiles between consecutive correct boundaries |
