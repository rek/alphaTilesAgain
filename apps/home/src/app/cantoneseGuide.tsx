...
const DOORS: Door[] = [
  ...
  },
  {
    ...
    difficulty: 'Medium',
    mechanic: 'Thailand · listen-and-pick',
    what: 'Same format as door 1 — hear a word, pick the picture — but distractors share more features with the correct answer.',
  ...
  },
  {
    ...
    difficulty: 'Hard',
    mechanic: 'Thailand · listen-and-pick',
    what: 'Same format as doors 1–2 with the hardest distractors. The distractors sound or look similar to the correct answer.',
  ...
  },
  {
    ...
    good: 'Reading practice with an audio prompt — easier than door 5 because the student hears the word.',
  },
  {
    index: 5,
      ...
      <main className="flex-grow px-6 py-12 md:py-20 max-w-5xl mx-auto w-full">
        <header className="mb-12">
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            The Cantonese build ships with nine games (doors). This page describes what each door does and who it's a good fit for, so a reviewer or teacher can point students at the right one.
          </p>
              ...
              <div className="flex items-start gap-4 md:gap-6">
                ...
                <div className="flex-grow min-w-0">
                  <div className="flex flex-wrap items-baseline gap-3 mb-2">
                    <h2 className="text-xl md:text-2xl font-bold text-slate-900">{door.title}</h2>
                    {door.difficulty && (
                      <span
                        className={`text-xs font-semibold px-2 py-0.5 rounded-full ${
                          DIFFICULTY_STYLES[door.difficulty] ?? 'bg-slate-100 text-slate-700'
                        }`}
                      >
                        {door.difficulty}
                      </span>
                  ...
                  <p className="text-sm font-mono text-slate-500 mb-3">{door.mechanic}</p>
                  <p className="text-slate-700 leading-relaxed mb-3">
                    <span className="font-semibold text-slate-900">What it does:</span> {door.what}
                  </p>
                  <p className="text-slate-700 leading-relaxed">
                    <span className="font-semibold text-slate-900">Good for:</span> {door.good}
                  </p>
                </div>
              </div>
            </article>
